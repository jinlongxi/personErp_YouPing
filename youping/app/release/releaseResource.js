...
class homeList extends React.Component {
    ...
    _releaseResourse() {
        DeviceStorage.get('tarjeta').then((tags) => {
            ...
            let url = ServiceURl.personManager + 'releaseResource?tarjeta=' + tags + '&productName=' + this.state.text + '&productCategoryId=' + this.props.productCategoryId;
            console.log(url);
            let data = [];
            let that=this;
    ...
    componentDidMount() {
        ...
        console.log(this.props.productCategoryId);
        this.setState({
